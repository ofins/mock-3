<template>
  ...
  >
    ...
    <div class="flex-col-center">
      <h1 class="m-headline-bold-xxl c-text-asInverse-04 z-2 tracking-widest m-0 xl:headline-bold-xxl">
        {{ text }}
      </h1>
...
const formattedDate = computed(() => {
  ...
  return new Date(date.value).toLocaleDateString('zh-TW', options).replace(/\//, '年').replace(/\//, '月') + '日';
});
