  ...
  <div class="bg-red lg:hidden" @click="handleClick($event)">
    ...
    <Transition name="slide-fade">
      ...
      >
        ...
        >
          <img src="../../assets/images/icons8-close-100.png" alt="close menu" class="w-20px" />
        </button>
        <!-- menu -->
...
const navbarSocials = {
  mail: '/src/assets/images/icons8-mail-100.png',
  facebook: '/src/assets/images/icons8-fb-100.png',
  instagram: '/src/assets/images/icons8-instagram-100.png'
}
</script>
